export const STRINGS = {
  newProposal: {
    ...
    error: {
      ...
      insufficientTokens: "Немате довољно токена за креирање предлога. За креирање предлога потребно је имати најмање 1 EVSD токен и делегирати их себи.",
      txRejectedByUser: "Трансакција је одбијена од стране корисника. Потребно је одобрити трансакцију у новчанику.",
      insufficientETH: "Недовољно средстава за плаћање трошкова трансакције (ETH).",
      insufficientEVSDTokens: "Недовољно EVSD токена за креирање предлога.",
      badData: "Проблем са прослеђеним подацима. Проверите да ли је адреса токена исправна и параметри одговарајући.",
      callException: "Трансакција је одбијена. Могућ проблем са адресом паметног уговора.",
      gasEstimate: "Неуспешна процена трошкова гаса. Проверите да ли испуњавате услове за предлог.",
  ...
  userActivity: {
    ...
    userProposals: {
      ...
      noProposalsDescription: 'Kada kreirate predlog za glasanje, pojaviće se ovde.',
    ...
    votingHistory: {
      ...
      noHistoryDescription: 'Kada glasate na predlozima, ovde će se prikazati vaša istorija glasanja.'
    }
  },
  voting: {
    voteOptions: {
