import { EvsdGovernor, EvsdGovernor__factory, EvsdToken, EvsdToken__factory } from "@/types/ethers-contracts";
...
export async function getProposals(governor: EvsdGovernor) : Promise<Proposal[]>
{
