...
export function NewProposalDialog({
  ...
  const moveSubItem = (id: string, direction: "up" | "down") => {
    const currentIndex = newProposal.subItems.findIndex(
      (item) => item.id === id
    );
                ...
                <div className="space-y-4 mt-2">
                  <div className="flex items-center justify-between">
                    <Label className="flex items-center gap-2">
                      ...
                      <span>
                        Подтачке предлога ({newProposal.subItems.length})
                      </span>
                    </Label>
                    <Button
                      type="button"
                  ...
                  {newProposal.subItems.length === 0 && (
                    <div className="bg-muted p-4 text-center rounded-md">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Додајте подтачке предлога на које ће се гласати
                        појединачно
                      </p>
                    </div>
                  )}
                  ...
                  <ScrollArea
                    className={
                      newProposal.subItems.length > 2 ? "h-[300px] pr-4" : ""
                    }
                  >
                    {newProposal.subItems.map((item, index) => (
                      ...
                      >
                        <div className="flex items-center justify-between p-3 bg-slate-100 border-b">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <Button
                              ...
                              disabled={
                                index === newProposal.subItems.length - 1
                              }
                              className="h-7 w-7 p-0 text-slate-500 hover:text-slate-700"
                            >
                        ...
                        <Accordion
                          ...
                          collapsible
                          value={
                            expandedSubItem === item.id ? item.id : undefined
                          }
                          onValueChange={(value) =>
                            setExpandedSubItem(value || null)
                          }
                        >
